...
_POST_RECAP_HINT = (
    ...
    "\n"
    "DECISION RULE — apply this BEFORE picking a branch.\n"
    ...
    "'change'. If ANY is present → Branch B or C, never A. Branch A is "
    "reserved for pure short affirmatives with ZERO new content. A reply "
    "that mixes 'ok' with new content (e.g. 'ok mais ajoute X') is still "
    "Branch C, not A.\n"
    "\n"
